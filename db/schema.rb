...
ActiveRecord::Schema.define(version: 2021_06_08_033351) do
  ...
  create_table "perform_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "performance_id"
    t.bigint "tag_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["performance_id"], name: "index_perform_tags_on_performance_id"
    t.index ["tag_id"], name: "index_perform_tags_on_tag_id"
  end
  ...
  add_foreign_key "perform_tags", "performances"
  add_foreign_key "perform_tags", "tags"
